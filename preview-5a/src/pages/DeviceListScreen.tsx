...
export function DeviceListScreen({
  ...
  return (
    <div className="flex flex-col h-full bg-arozen-grey relative">
      {/* Header */}
      <div className="bg-white px-6 pt-14 pb-4 shadow-sm shadow-gray-200 z-10">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 phone-scroll">
        ...
        <div className="space-y-2 pb-4">
            ...
            onClick={onAddDevice}
            className="w-full mb-3 bg-white border border-gray-200 rounded-2xl px-4 py-2.5 flex items-center justify-between shadow-sm shadow-gray-200 font-body">
