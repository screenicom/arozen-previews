...
export function DeviceCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="bg-[#F5F2EC] rounded-2xl p-4 flex items-center justify-between cursor-pointer shadow-[0_8px_20px_-8px_rgba(60,40,15,0.18),0_2px_5px_-1px_rgba(60,40,15,0.10)]">
