        ...
        <div className="px-1">
          ...
          <div className="flex justify-between mt-3 px-1">
            ...
            <button
              ...
              className={`text-[10px] font-medium font-body transition-colors ${i === intensity ? 'text-arozen-black' : 'text-gray-400'}`}
              style={{
                flex: i === 0 || i === maxIntensity ? 0 : 1,
                textAlign:
                i === 0 ? 'left' : i === maxIntensity ? 'right' : 'center'
              }}>
