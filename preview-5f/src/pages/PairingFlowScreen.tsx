        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            <div className="flex flex-col items-center text-center mt-10">
                ...
                <h2 className="text-2xl font-medium text-gray-900 mb-2 font-heading">
                  Successfully Paired!
                </h2>
                <p className="text-gray-500 font-body">
                  Your diffuser is now connected and ready to use.
                </p>

                <div className="w-full text-left mt-10 pt-8 border-t border-gray-200">
                  <h3 className="text-lg font-medium text-gray-900 mb-1 font-heading">
