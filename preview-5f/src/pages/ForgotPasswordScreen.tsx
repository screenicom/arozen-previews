...
export function ForgotPasswordScreen({
  ...
  return (
    <div className="flex flex-col h-full bg-arozen-grey px-6 pt-14 pb-8 overflow-y-auto phone-scroll relative">
      {step !== 'success' &&
      <button
        onClick={handleBack}
      ...
      <AnimatePresence mode="wait">
        ...
        <motion.form
          ...
          className="flex-1 flex flex-col">
            ...
            className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent transition-shadow"
            ...
            <div className="pt-6 mt-auto">
              ...
              type="submit"
              disabled={!emailValid}
              className={`w-full font-medium py-4 rounded-xl font-body shadow-lg transition-colors ${emailValid ? 'bg-arozen-black text-white shadow-black/20' : 'bg-gray-100 text-gray-400 cursor-not-allowed shadow-none'}`}>
        ...
        <motion.form
          ...
          className="flex-1 flex flex-col">
            ...
            <input
              ...
              className={`w-12 h-14 text-center bg-white border rounded-xl text-xl font-medium text-gray-900 font-heading focus:outline-none focus:ring-2 focus:ring-arozen-gold transition-shadow ${codeError ? 'border-arozen-danger/40' : 'border-gray-200 focus:border-transparent'}`} />
          ...
          <p className="text-xs text-arozen-danger font-body mt-2">
            ...
            <div className="pt-6 mt-auto">
              ...
              className={`w-full font-medium py-4 rounded-xl font-body shadow-lg transition-colors ${codeComplete ? 'bg-arozen-black text-white shadow-black/20' : 'bg-gray-100 text-gray-400 cursor-not-allowed shadow-none'}`}>
        ...
        <motion.form
          ...
          className="flex-1 flex flex-col">
            ...
            <div className="pt-6 mt-auto">
              ...
              type="submit"
              disabled={!canUpdate}
              className={`w-full font-medium py-4 rounded-xl font-body shadow-lg transition-colors ${canUpdate ? 'bg-arozen-black text-white shadow-black/20' : 'bg-gray-100 text-gray-400 cursor-not-allowed shadow-none'}`}>
