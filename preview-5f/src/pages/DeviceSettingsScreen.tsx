  ...
  return (
    <div className="flex flex-col h-full bg-arozen-grey relative">
      <div className="px-4 pt-14 pb-4 flex justify-between items-center z-10">
        ...
        <button
          onClick={handleSave}
          className="bg-arozen-black text-white font-medium text-sm font-body px-4 py-2 rounded-lg shadow-sm shadow-black/20 active:scale-[0.97] transition-transform">
        ...
        <div className="bg-white rounded-2xl overflow-hidden">
          <div className="p-4 border-b border-gray-100">
            ...
            <input
              ...
              className="w-full bg-arozen-grey border border-gray-200 rounded-lg px-3 py-2 text-gray-900 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent transition-shadow" />
