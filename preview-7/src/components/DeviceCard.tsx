...
export function DeviceCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`rounded-2xl p-4 flex items-center justify-between cursor-pointer shadow-[0_8px_20px_-8px_rgba(60,40,15,0.18),0_2px_5px_-1px_rgba(60,40,15,0.10)] ${device.isOn ? 'bg-[#f5f2ec]' : 'bg-neutral-100'}`}>
      
      <div className="flex items-center space-x-4 min-w-0">
        <div
          className={`relative w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 ${device.isOn ? 'bg-arozen-green/10' : 'bg-neutral-200 border border-black/[0.05]'}`}>
        ...
        <motion.button
          ...
          <div
            ...
            style={{
              ...
              'linear-gradient(180deg, #F2F2F2 0%, #DFDFDF 100%)',
              boxShadow: !device.isOnline ?
