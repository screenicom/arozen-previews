...
export function DeviceCard({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={`rounded-2xl p-4 flex items-center justify-between cursor-pointer shadow-[0_4px_14px_-6px_rgba(0,0,0,0.08),0_1px_3px_-1px_rgba(0,0,0,0.04)] ${device.isOn ? 'bg-[#f5f2ec]' : 'bg-neutral-100'}`}>
