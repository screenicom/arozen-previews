...
export function DeviceControlScreen({
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden wall-bg">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 phone-scroll">
        ...
        <div className="rounded-3xl px-5 pt-5 pb-4 relative overflow-hidden shadow-[0_8px_28px_-12px_rgba(0,0,0,0.10),0_2px_6px_-1px_rgba(0,0,0,0.04)] bg-neutral-100">
        ...
        <button
          ...
          disabled={isOffline}
          className={`w-full bg-neutral-100 rounded-2xl px-4 py-3.5 flex items-center justify-between transition-opacity shadow-[0_4px_14px_-6px_rgba(0,0,0,0.08),0_1px_3px_-1px_rgba(0,0,0,0.04)] ${isOffline ? 'opacity-50' : 'active:scale-[0.99]'} text-left`}>
...
function PillControl({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`bg-neutral-100 rounded-2xl pl-2 pr-2 py-2 flex items-center gap-2 text-left transition-opacity shadow-[0_4px_14px_-6px_rgba(0,0,0,0.08),0_1px_3px_-1px_rgba(0,0,0,0.04)] ${disabled ? 'opacity-50' : ''} ${mirrored ? 'flex-row-reverse' : ''}`}>
