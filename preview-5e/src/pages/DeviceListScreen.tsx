...
export function DeviceListScreen({
  ...
  return (
    <div className="flex flex-col h-full relative wall-bg">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 phone-scroll">
        ...
        <div className="flex flex-col items-center justify-center h-full text-center px-6">
            <div className="w-24 h-24 bg-neutral-100 rounded-full flex items-center justify-center mb-6 shadow-sm">
        ...
        <div className="space-y-2 pb-4">
            ...
            onClick={onAddDevice}
            className="w-full mb-3 bg-neutral-100 rounded-2xl px-4 py-2.5 flex items-center justify-between font-body shadow-[0_4px_14px_-6px_rgba(0,0,0,0.08),0_1px_3px_-1px_rgba(0,0,0,0.04)]">
