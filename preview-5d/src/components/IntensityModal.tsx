      ...
      <>
          ...
          className="absolute bottom-0 inset-x-0 bg-white rounded-t-3xl z-50 px-6 pt-5 pb-8 shadow-2xl">
            ...
            <div className="text-center my-8">
              ...
              className="text-3xl font-medium text-arozen-gold font-heading">
            ...
            <div className="px-1">
              ...
              style={{
                background: `linear-gradient(to right, #B59869 0%, #B59869 ${localValue / (INTENSITY_LEVELS.length - 1) * 100}%, #F3F4F6 ${localValue / (INTENSITY_LEVELS.length - 1) * 100}%, #F3F4F6 100%)`
              }} />
              ...
              <button
                ...
                className={`text-[10px] font-medium font-body transition-colors ${i === localValue ? 'text-arozen-gold' : 'text-gray-400'}`}
                style={{
                  flex:
