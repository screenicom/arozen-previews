...
export function PowerCircle({
  ...
  // Off state — flatter, subtler 3D
  const offOuter = '#EBE7DE';
  const offInner1 = '#EFEDE7';
  const offInner2 = '#DFDACE';
  const disabledOuter = '#ECE9E2';
  const disabledInner1 = '#EFEDE7';
  const disabledInner2 = '#E2DED4';
  ...
  '0 3px 8px rgba(80,60,30,0.06)' :
  isOn ?
  '0 10px 24px rgba(60,90,40,0.28), 0 2px 4px rgba(60,90,40,0.16)' :
  '0 3px 10px rgba(80,60,30,0.10), 0 1px 2px rgba(80,60,30,0.05)';
  return (
