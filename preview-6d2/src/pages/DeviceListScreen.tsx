    ...
    <div className="flex flex-col h-full wall-bg relative">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 phone-scroll">
        ...
        <div className="space-y-2 pb-4">
            ...
            onClick={onAddDevice}
            className="w-full mb-3 bg-white rounded-2xl px-4 py-2.5 flex items-center justify-between font-body shadow-[0_8px_20px_-8px_rgba(60,40,15,0.18),0_2px_5px_-1px_rgba(60,40,15,0.10)]">
