  ...
  return (
    <div className="flex flex-col h-full bg-black relative">
      <div className="bg-arozen-dark px-4 pt-14 pb-4 flex justify-between items-center shadow-md shadow-black/40 z-10">
        ...
        <h1 className="text-lg font-medium text-white font-heading">About</h1>
        <div className="w-10" />
      </div>

      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6 phone-scroll">
        <div className="bg-arozen-dark rounded-2xl p-6 shadow-md shadow-black/40 border border-white/10 text-center">
          <div className="w-16 h-16 bg-arozen-gold/20 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="bg-arozen-dark rounded-2xl shadow-md shadow-black/40 border border-white/10 overflow-hidden">
          ...
          <a
            ...
            <div className="flex items-center space-x-3">
              <ExternalLinkIcon className="w-5 h-5 text-white/40" />
              <span className="text-sm font-medium text-white font-body">
                Visit our shop
              </span>
            </div>
          ...
          <a
            ...
            <div className="flex items-center space-x-3">
              <FileTextIcon className="w-5 h-5 text-white/40" />
              <span className="text-sm font-medium text-white font-body">
                Terms & Conditions
              </span>
            </div>
