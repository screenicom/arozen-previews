  ...
  return (
    <div className="flex flex-col h-full bg-black relative">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 phone-scroll">
        <div className="mb-8">
          <h2 className="text-sm font-medium text-white mb-4 font-body">
            Active Days
          </h2>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-sm font-medium text-white font-body">
              Time Blocks
            </h2>
          ...
          <button
            ...
            className="w-full mt-4 border-2 border-dashed border-arozen-gold/30 text-white/50 font-medium py-4 rounded-2xl flex items-center justify-center space-x-2 hover:border-arozen-gold hover:text-arozen-gold transition-colors font-body">
