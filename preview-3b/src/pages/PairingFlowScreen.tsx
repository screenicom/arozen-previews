  ...
  return (
    <div className="flex flex-col h-full bg-black relative">
      <div className="px-4 pt-14 pb-4 flex justify-between items-center z-10">
        ...
        <button
          onClick={onCancel}
          className="p-2 text-white/40 hover:text-white text-sm font-medium font-body">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col phone-scroll">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            <div className="flex flex-col items-center text-center mt-8">
                <div className="w-20 h-20 bg-arozen-gold/20 rounded-full flex items-center justify-center mb-6">
                ...
                <div className="bg-arozen-dark rounded-xl p-4 w-full text-left border border-white/10">
            ...
            {step === 2 &&
            <div className="flex flex-col items-center text-center mt-8">
                <div className="w-48 h-48 bg-arozen-dark rounded-3xl mb-8 relative overflow-hidden flex items-center justify-center border border-white/10">
                  <div className="absolute top-4 right-4 w-3 h-3 bg-arozen-gold rounded-full animate-pulse" />
                  <span className="text-white/40 font-medium font-body">
            ...
            {step === 3 &&
            <div className="flex flex-col items-center text-center mt-8">
                <div className="w-24 h-24 bg-arozen-gold/20 rounded-full flex items-center justify-center mb-6 relative">
                  {isScanning ?
                <>
                ...
                {deviceType &&
              <div className="w-full bg-arozen-dark border-2 border-arozen-gold rounded-xl p-4 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-arozen-gold/20 rounded-full flex items-center justify-center">
            ...
            <div className="flex flex-col mt-4">
                <div className="flex items-center justify-center w-16 h-16 bg-arozen-gold/20 rounded-full mx-auto mb-6">
                  <WifiIcon className="w-8 h-8 text-arozen-gold" />
                </div>
                <h2 className="text-2xl font-medium text-white mb-2 text-center font-heading">
                  Connect to Wi-Fi
                </h2>
                <p className="text-white/60 mb-8 text-center text-sm font-body">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    className="w-full bg-arozen-dark border border-white/10 rounded-xl px-4 py-3 text-white font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold" />
                  ...
                  <div>
                    ...
                    className="w-full bg-arozen-dark border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold" />
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                <input
                  ...
                  className="w-14 h-16 text-center text-2xl font-bold bg-arozen-dark border border-white/10 rounded-xl text-white font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent" />

                )}
                </div>
                <button
                onClick={() => setStep(6)}
                className="text-white/40 text-sm font-medium hover:text-white/60 font-body">
            ...
            <div className="flex flex-col items-center text-center mt-12">
                ...
                className="w-24 h-24 bg-arozen-gold/20 rounded-full flex items-center justify-center mb-6">
        ...
        <div className="mt-auto pt-6">
          <button
            ...
            className={`w-full font-medium py-4 rounded-xl shadow-lg transition-all font-body ${isScanning ? 'bg-arozen-dark text-white/30 cursor-not-allowed' : 'bg-arozen-gold text-white shadow-arozen-gold/20 active:scale-[0.98]'}`}>
