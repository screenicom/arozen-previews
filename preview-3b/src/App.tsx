...
export function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-4 font-body">
      {/* Mobile Phone Frame */}
      <div className="relative w-full max-w-[390px] h-[844px] bg-black rounded-[3rem] shadow-2xl shadow-black/50 overflow-hidden border-[8px] border-arozen-dark ring-1 ring-white/10">
        {/* Fake Status Bar */}
        <div className="absolute top-0 inset-x-0 h-12 flex items-center justify-between px-6 z-50 pointer-events-none">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="w-4 h-3 bg-white/80 rounded-sm" />
            <div className="w-6 h-3 border border-white/80 rounded-sm p-[1px]">
        ...
        <div className="absolute top-2 inset-x-0 flex justify-center z-50 pointer-events-none">
          <div className="w-32 h-7 bg-black border border-white/5 rounded-full" />
        </div>
