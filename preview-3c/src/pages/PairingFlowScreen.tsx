      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col phone-scroll">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                <div className="bg-arozen-grey rounded-xl p-4 w-full text-left border border-gray-200">
            ...
            {step === 2 &&
            <div className="flex flex-col items-center text-center mt-8">
                <div className="w-48 h-48 bg-arozen-grey rounded-3xl mb-8 relative overflow-hidden flex items-center justify-center border border-gray-200">
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                <input
                  ...
                  className="w-14 h-16 text-center text-2xl font-bold bg-arozen-grey border border-gray-200 rounded-xl text-gray-900 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent" />
        ...
        <div className="mt-auto pt-6">
          <button
            ...
            className={`w-full font-medium py-4 rounded-xl shadow-lg transition-all font-body ${isScanning ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-arozen-gold text-white shadow-arozen-gold/20 active:scale-[0.98]'}`}>
