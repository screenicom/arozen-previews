...
export function LoginScreen({ onLogin }: LoginScreenProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-white px-6 pt-16 pb-8 overflow-y-auto phone-scroll">
      <div className="flex flex-col items-center mb-10">
        <div className="w-16 h-16 bg-arozen-gold/10 rounded-full flex items-center justify-center mb-4">
