...
export function DeviceControlScreen({
  ...
  return (
    <div className="flex flex-col h-full bg-arozen-grey relative">
      ...
      {isOffline &&
      <div className="bg-red-50 border-b border-red-100 px-4 py-2 flex items-center justify-center">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-8 phone-scroll">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500 font-medium uppercase tracking-wider font-body">
              Status
            </p>
            <p
              className={`text-xl font-medium font-heading ${device.isOn ? 'text-arozen-gold' : 'text-gray-400'}`}>
        ...
        {/* Controls Container */}
        <div
          className={`bg-white rounded-3xl p-5 shadow-sm shadow-gray-200 border border-gray-200 space-y-6 ${isOffline ? 'opacity-50 pointer-events-none' : ''}`}>
          ...
          <div>
            <div className="flex justify-between items-center mb-3">
              ...
              <span className="text-xs text-arozen-gold font-medium bg-arozen-gold/10 px-2 py-1 rounded-md font-body">
        ...
        <button
          ...
          className="w-full bg-white rounded-2xl p-4 shadow-sm shadow-gray-200 border border-gray-200 flex items-center justify-between active:scale-[0.98] transition-transform">
          
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-arozen-gold/10 rounded-full flex items-center justify-center text-arozen-gold">
              <CalendarIcon className="w-5 h-5" />
            </div>
            <div className="text-left">
              <h3 className="font-medium text-gray-900 font-body">Schedule</h3>
