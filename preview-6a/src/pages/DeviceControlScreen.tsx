...
export function DeviceControlScreen({
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-[#E4F1DD] via-[#F8F0DA] to-[#D8E9C9] relative overflow-hidden">
      {/* Header */}
      ...
      {/* Offline notice */}
      {isOffline &&
      <div className="mx-4 mt-1 mb-2 bg-arozen-danger/10 rounded-2xl px-4 py-3 flex items-start gap-3">
          <div className="w-8 h-8 rounded-full bg-arozen-danger/20 flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 phone-scroll">
        ...
        <div className="rounded-3xl px-5 pt-5 pb-4 relative overflow-hidden bg-white/60 backdrop-blur-md">
          {/* Animated background when device is ON */}
          ...
          <>
              ...
              style={{
                background:
                'linear-gradient(-45deg, #B8D4A8, #E8D5A0, #A8C9D4, #D4B8A8)',
              ...
              style={{
                ...
                height: 260,
                background:
                'radial-gradient(circle, rgba(132,168,106,0.7) 0%, rgba(132,168,106,0) 70%)',
                filter: 'blur(20px)',
                top: '10%',
                left: '-10%'
              }}
              ...
              style={{
                ...
                height: 240,
                background:
                'radial-gradient(circle, rgba(181,152,105,0.7) 0%, rgba(181,152,105,0) 70%)',
                filter: 'blur(24px)',
                top: '30%',
                right: '-15%'
              }}
              ...
              style={{
                ...
                height: 220,
                background:
                'radial-gradient(circle, rgba(168,201,212,0.65) 0%, rgba(168,201,212,0) 70%)',
                filter: 'blur(22px)',
                bottom: '5%',
                left: '20%'
              }}
          ...
          <div className="flex flex-col items-center pt-0 pb-2 relative z-20">
            ...
            <p
              className={`mt-3 text-[13px] font-medium font-body relative z-20 ${isOffline ? 'text-gray-400' : device.isOn ? 'text-arozen-green' : 'text-gray-500'}`}>
        ...
        <button
          ...
          disabled={isOffline}
          className={`w-full bg-white/60 backdrop-blur-md rounded-2xl px-4 py-3.5 flex items-center justify-between transition-opacity ${isOffline ? 'opacity-50' : 'active:scale-[0.99]'} text-left`}>
          
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-full bg-white/80 flex items-center justify-center flex-shrink-0">
              <CalendarIcon
...
function PillControl({
  ...
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`bg-white/60 backdrop-blur-md rounded-2xl pl-2 pr-2 py-2 flex items-center gap-2 text-left transition-opacity ${disabled ? 'opacity-50' : ''} ${mirrored ? 'flex-row-reverse' : ''}`}>
