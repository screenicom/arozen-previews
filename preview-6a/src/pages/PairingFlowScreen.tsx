      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col phone-scroll">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                <div className="bg-white/60 backdrop-blur-md rounded-xl p-4 w-full text-left border border-white/20">
            ...
            {step === 2 &&
            <div className="flex flex-col items-center text-center mt-8">
                <div className="w-48 h-48 bg-white/60 backdrop-blur-md rounded-3xl mb-8 relative overflow-hidden flex items-center justify-center border border-white/20">
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                {deviceType &&
              <div className="w-full bg-white/60 backdrop-blur-md border border-arozen-gold/50 rounded-xl p-4 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col mt-4">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    className="w-full bg-white/60 backdrop-blur-md border border-white/20 rounded-xl px-4 py-3 text-gray-900 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold" />
                  ...
                  <div>
                    ...
                    className="w-full bg-white/60 backdrop-blur-md border border-white/20 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-400 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold" />
            ...
            <div className="flex flex-col items-center text-center mt-8">
                ...
                <input
                  ...
                  className="w-14 h-16 text-center text-2xl font-bold bg-white/60 backdrop-blur-md border border-white/20 rounded-xl text-gray-900 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent" />

                )}
                </div>
                <button
                onClick={() => setStep(6)}
                className="text-gray-400 text-sm font-medium hover:text-gray-600 font-body">
        ...
        <div className="mt-auto pt-6">
          <button
            ...
            className={`w-full font-medium py-4 rounded-xl transition-all font-body ${isScanning ? 'bg-white/50 text-gray-400 cursor-not-allowed' : 'bg-arozen-black text-white active:scale-[0.98]'}`}>
