  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-[#E4F1DD] via-[#F8F0DA] to-[#D8E9C9] relative">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 space-y-6 phone-scroll">
        {/* Profile Header */}
        <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 text-center border border-white/20">
        ...
        <>
            ...
            className="absolute bottom-0 inset-x-0 bg-white rounded-t-3xl z-50 px-6 pt-5 pb-8 shadow-2xl">
              ...
              <div className="space-y-2">
                ...
                className="w-full bg-arozen-danger text-white font-medium py-4 rounded-xl active:scale-[0.98] transition-transform font-body">
    ...
    <AnimatePresence>
      ...
      <>
          ...
          className="absolute bottom-0 inset-x-0 bg-white rounded-t-3xl z-50 px-6 pt-5 pb-8 shadow-2xl">
            ...
            <div className="space-y-4">
              <div className="flex space-x-3">
                <div className="flex-1">
                  ...
                  className="w-full bg-white/60 backdrop-blur-md border border-white/20 rounded-xl px-4 py-3 text-gray-900 font-body focus:outline-none focus:ring-2 focus:ring-arozen-gold focus:border-transparent transition-shadow" />
            ...
            <button
            onClick={handleSave}
            className="w-full bg-arozen-black text-white font-medium py-4 rounded-xl active:scale-[0.98] transition-transform font-body mt-8">
    ...
    <AnimatePresence>
      ...
      <>
          ...
          className="absolute bottom-0 inset-x-0 bg-white rounded-t-3xl z-50 px-6 pt-5 pb-8 shadow-2xl">
            ...
            <button
            onClick={handleSave}
            className={`w-full font-medium py-4 rounded-xl font-body active:scale-[0.98] transition-transform mt-8 flex items-center justify-center space-x-2 ${saved ? 'bg-arozen-green text-white' : 'bg-arozen-black text-white'}`}>
