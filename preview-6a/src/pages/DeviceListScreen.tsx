    ...
    <div className="flex flex-col h-full bg-gradient-to-br from-[#E4F1DD] via-[#F8F0DA] to-[#D8E9C9] relative">
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-3 pb-6 phone-scroll">
        ...
        <div className="flex flex-col items-center justify-center h-full text-center px-6">
            <div className="w-24 h-24 bg-white/60 backdrop-blur-md rounded-full flex items-center justify-center mb-6">
            ...
            <button
            onClick={onAddDevice}
            className="bg-arozen-black text-white font-medium py-3 px-8 rounded-xl active:scale-95 transition-transform font-body">
        ...
        <div className="space-y-2 pb-4">
            ...
            onClick={onAddDevice}
            className="w-full mb-3 bg-white/60 backdrop-blur-md rounded-2xl px-4 py-2.5 flex items-center justify-between font-body">
