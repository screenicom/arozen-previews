      ...
      <>
          ...
          className="absolute bottom-0 inset-x-0 bg-white rounded-t-3xl z-50 px-6 pt-5 pb-8 shadow-2xl">
            ...
            <div className="px-1">
              ...
              style={{
                background: `linear-gradient(to right, #B59869 0%, #B59869 ${fillPercent}%, #F3F4F6 ${fillPercent}%, #F3F4F6 100%)`
              }} />
              ...
              <button
                ...
                className={`text-xs font-medium font-body transition-colors ${i === localIndex ? 'text-arozen-gold' : 'text-gray-400'}`}>
